...
namespace Savage_Hotel_System {
    ...
    public partial class DatabaseHotelDataSet : global::System.Data.DataSet {
        ...
        public partial class FuncionarioDataTable : global::System.Data.TypedTableBase<FuncionarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public FuncionarioRow AddFuncionarioRow(int Id, string Name, string LastName, string Login, string Password, decimal Salary, int IsManager) {
        ...
        public partial class FuncionarioRow : global::System.Data.DataRow {
            ...
            public string LastName {
                get {
                    return ((string)(this[this.tableFuncionario.LastNameColumn]));
                }
                set {
                    this[this.tableFuncionario.LastNameColumn] = value;
                }
            }
...
namespace Savage_Hotel_System.DatabaseHotelDataSetTableAdapters {
    ...
    public partial class FuncionarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Funcionario] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([LastName] = @Original_LastName) AND ([Login] = @Original_Login) AND ([Password] = @Original_Password) AND ([Salary] = @Original_Salary) AND ([IsManager] = @Original_IsManager))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Funcionario] ([Id], [Name], [LastName], [Login], [Password], [Salary], [IsManager]) VALUES (@Id, @Name, @LastName, @Login, @Password, @Salary, @IsManager);
SELECT Id, Name, LastName, Login, Password, Salary, IsManager FROM Funcionario WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Funcionario] SET [Id] = @Id, [Name] = @Name, [LastName] = @LastName, [Login] = @Login, [Password] = @Password, [Salary] = @Salary, [IsManager] = @IsManager WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([LastName] = @Original_LastName) AND ([Login] = @Original_Login) AND ([Password] = @Original_Password) AND ([Salary] = @Original_Salary) AND ([IsManager] = @Original_IsManager));
SELECT Id, Name, LastName, Login, Password, Salary, IsManager FROM Funcionario WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, LastName, Login, Password, Salary, IsManager FROM dbo.Funcionari" +
                "o";
        ...
        public virtual int Fill(DatabaseHotelDataSet.FuncionarioDataTable dataTable) {
        ...
        public virtual DatabaseHotelDataSet.FuncionarioDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseHotelDataSet.FuncionarioDataTable dataTable = new DatabaseHotelDataSet.FuncionarioDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseHotelDataSet.FuncionarioDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_LastName, string Original_Login, string Original_Password, decimal Original_Salary, int Original_IsManager) {
        ...
        public virtual int Insert(int Id, string Name, string LastName, string Login, string Password, decimal Salary, int IsManager) {
        ...
        public virtual int Update(int Id, string Name, string LastName, string Login, string Password, decimal Salary, int IsManager, int Original_Id, string Original_Name, string Original_LastName, string Original_Login, string Original_Password, decimal Original_Salary, int Original_IsManager) {
            ...
            this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(Original_IsManager));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string LastName, string Login, string Password, decimal Salary, int IsManager, int Original_Id, string Original_Name, string Original_LastName, string Original_Login, string Original_Password, decimal Original_Salary, int Original_IsManager) {
            return this.Update(Original_Id, Name, LastName, Login, Password, Salary, IsManager, Original_Id, Original_Name, Original_LastName, Original_Login, Original_Password, Original_Salary, Original_IsManager);
        }
    }
