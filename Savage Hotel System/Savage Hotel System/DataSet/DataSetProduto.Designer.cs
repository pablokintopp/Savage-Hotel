    ...
    public partial class DataSetProduto : global::System.Data.DataSet {
        ...
        public partial class ProdutoRow : global::System.Data.DataRow {
            ...
            public string IdFornecedor {
                get {
                    return ((string)(this[this.tableProduto.IdFornecedorColumn]));
                }
                set {
            ...
            public string Name {
                get {
                    return ((string)(this[this.tableProduto.NameColumn]));
                }
                set {
                    this[this.tableProduto.NameColumn] = value;
                }
            }
            ...
            public int Expr1 {
                get {
                    return ((int)(this[this.tableProduto.Expr1Column]));
                }
                set {
                    this[this.tableProduto.Expr1Column] = value;
                }
            }
        }
...
namespace Savage_Hotel_System.DataSet.DataSetProdutoTableAdapters {
    ...
    public partial class ProdutoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        Produto.Id, Produto.Nome, Produto.Valor, Produto.IdFornecedor, Fornecedor.Name, Fornecedor.Id AS Expr1
FROM            Produto INNER JOIN
                         Fornecedor ON Produto.IdFornecedor = Fornecedor.Id
WHERE        (Produto.Id = @Param1)";
            ...
            this._commandCollection[1].CommandText = "SELECT        Produto.Id, Produto.Nome, Produto.Valor, Produto.IdFornecedor, Forn" +
                "ecedor.Name, Fornecedor.Id AS Expr1\r\nFROM            Produto INNER JOIN\r\n       " +
                "                  Fornecedor ON Produto.IdFornecedor = Fornecedor.Id";
        ...
        public virtual int busca_2(DataSetProduto.ProdutoDataTable dataTable, int Param1) {
        ...
        public virtual int Busca_Listar(DataSetProduto.ProdutoDataTable dataTable) {
...
SELECT Id, Name, CNPJ, Phone FROM Fornecedor WHERE (Id = @Id)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(DataSetProduto.FornecedorDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        public virtual DataSetProduto.FornecedorDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSetProduto.FornecedorDataTable dataTable = new DataSetProduto.FornecedorDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetProduto.FornecedorDataTable dataTable) {
